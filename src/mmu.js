export default function MMU() {
  ...
  return {
    ...
    /**
     * Switchable ROM bank (01 .. NN) starting address
     */
    romOffset: 0x4000,
    ramOffset: 0,
    ...
    reset() {
      for (let i = 0; i < 8192; i += 1) this.wram[i] = 0;
      for (let i = 0; i < 32768; i += 1) this.eram[i] = 0;
      for (let i = 0; i < 127; i += 1) this.zram[i] = 0;
